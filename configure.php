...
*/
  define('MODULE_PAYMENT_CC_CVC_STATUS','False');
  define('MODULE_PAYMENT_PAYPAL_WPP_STATUS','True');
  define('MODULE_PAYMENT_PAYPAL_WPP_API_USERNAME', 'evikretail_api1.gmail.com');
  define('MODULE_PAYMENT_PAYPAL_WPP_API_PASSWORD', 'NAA7HE7EB6K33K9G');
  define('MODULE_PAYMENT_PAYPAL_WPP_API_SIGNATURE', 'A4EZjTCBtchdZmuHVjiYR1M6YFN6AS35C2P6KB.qRq2S.4XywcKooEQD');
