...
//henry disable so that file php_error_log.txt dont get filled up
...
//IT Service Zone: frontend admin access. START
//UPDATE cookies_time everytime admin visit a page in admin folder.
if ( isset($_SESSION['login_id']) ){
    $cookies_time = time()+ 3600*2;				//set 2 houra for time-out
    setcookie("login_id", $_SESSION['login_id'], $cookies_time, "/");
}
//IT Service Zone: frontend admin access. EOF
